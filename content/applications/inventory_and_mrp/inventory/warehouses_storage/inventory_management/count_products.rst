...
.. note::
   ...
   product line with its own lot/serial number, under the :guilabel:`Lot/Serial Number`
   column.
...
<inventory_management/count_products/inventory-adjustments-page>` page, click :guilabel:`New`. Doing
...
.. tip::
   ...
   button at the top of the :ref:`Inventory Adjustments
   <inventory_management/count_products/inventory-adjustments-page>` page.
